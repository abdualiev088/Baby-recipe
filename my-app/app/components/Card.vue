...
defineProps({
  ...
  ageUnit:        { type: String,  default: 'moNT' },
  lowAllergyRisk: { type: Boolean, default: true },
})
</script>

<template>
  <div class="w-full rounded-2xl overflow-hidden shadow-md bg-white hover:-translate-y-2 t transition duration-300 ease-in-out">

    <!-- Image section -->
    <div class="relative h-[170px] bg-gradient-to-br from-[#cce8e0] to-[#a8d4c8] flex items-center justify-center overflow-hidden ">
      ...
      <!-- Favourite button -->
      <button class="absolute top-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center shadow-sm hover:scale-105 transition-transform z-10">
      ...
      <!-- Meal image -->
      <img :src="image" alt="Meal" class="w-full object-contain drop-shadow-md object-cover" />
    </div>
